          ...
          >
            ...
            <div className="hero-content text-center text-white">
              <div className="max-w-xl">
                ...
                <h1 className="mb-5 text-3xl md:text-4xl font-bold">Sophia Davis</h1>
                <p className="mb-5">
          ...
          >
            ...
            <div className="hero-content text-center text-white">
              <div className="max-w-xl">
                ...
                <h1 className="mb-5 text-3xl md:text-4xl font-bold">Daniel Mitchell</h1>
                <p className="mb-5">
          ...
          >
            ...
            <div className="hero-content text-center text-white">
              <div className="max-w-xl">
                ...
                <h1 className="mb-5 text-3xl md:text-4xl font-bold">Olivia Parker</h1>
                <p className="mb-5">
          ...
          >
            ...
            <div className="hero-content text-center text-white">
              <div className="max-w-xl">
                ...
                <h1 className="mb-5 text-3xl md:text-4xl font-bold">William Johnson</h1>
                <p className="mb-5">
